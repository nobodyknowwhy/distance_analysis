...
if __name__ == '__main__':
    with mp.Manager() as manager:
        ...
        p_list = []
        for root_name, dir_name_list, file_name_list in os.walk(r"D:\gs\distance_analysis\aes\out\third_clean"):
        ...
        df.to_csv(r"D:\gs\distance_analysis\aes\out\test\aes_g_c_v_3clean_168.csv", index=False)
